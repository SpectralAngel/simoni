...
use Indira\SimoniBundle\Entity\Imagen;
use Indira\SimoniBundle\Form\ImagenType;
...
class ImagenController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IndiraSimoniBundle:Imagen')->findAll();

        return $this->render('IndiraSimoniBundle:Imagen:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('IndiraSimoniBundle:Imagen:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IndiraSimoniBundle:Imagen')->find($id);
        ...
        return $this->render('IndiraSimoniBundle:Imagen:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('IndiraSimoniBundle:Imagen:edit.html.twig', array(
            'entity'      => $entity,
