 ...
 */
class Version20130621013442 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE SEQUENCE Avistamiento_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        $this->addSql("CREATE SEQUENCE AvistamientoImportado_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        ...
        $this->addSql("CREATE SEQUENCE NivelEducativo_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        $this->addSql("CREATE SEQUENCE Pais_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        $this->addSql("CREATE SEQUENCE Reino_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        $this->addSql("CREATE SEQUENCE Sexo_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        $this->addSql("CREATE SEQUENCE TipoAvistamiento_id_seq INCREMENT BY 1 MINVALUE 1 START 1");
        ...
        $this->addSql("CREATE TABLE Departamento (id INT NOT NULL, nombre VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("CREATE TABLE Edad (id INT NOT NULL, reino_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
        $this->addSql("CREATE INDEX IDX_F469EB48A165460F ON Edad (reino_id)");
        ...
        $this->addSql("CREATE TABLE NivelEducativo (id INT NOT NULL, nivel VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
        $this->addSql("CREATE TABLE Pais (id INT NOT NULL, nombre VARCHAR(255) NOT NULL, bandera VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("CREATE TABLE fos_user (id INT NOT NULL, departamento_id INT DEFAULT NULL, pais_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, username_canonical VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, email_canonical VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, salt VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, last_login TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, locked BOOLEAN NOT NULL, expired BOOLEAN NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, roles TEXT NOT NULL, credentials_expired BOOLEAN NOT NULL, credentials_expire_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, nombre VARCHAR(255) DEFAULT NULL, apellidos VARCHAR(255) DEFAULT NULL, identidad VARCHAR(255) DEFAULT NULL, fechaDeNacimiento TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, telefono VARCHAR(255) DEFAULT NULL, direccion VARCHAR(255) DEFAULT NULL, nivelEducativo_id INT DEFAULT NULL, PRIMARY KEY(id))");
        $this->addSql("CREATE UNIQUE INDEX UNIQ_957A647992FC23A8 ON fos_user (username_canonical)");
        $this->addSql("CREATE UNIQUE INDEX UNIQ_957A6479A0D96FBF ON fos_user (email_canonical)");
        $this->addSql("CREATE INDEX IDX_957A64795A91C08D ON fos_user (departamento_id)");
        $this->addSql("CREATE INDEX IDX_957A6479C604D5C6 ON fos_user (pais_id)");
        $this->addSql("CREATE INDEX IDX_957A64793D8C63B3 ON fos_user (nivelEducativo_id)");
        ...
        $this->addSql("ALTER TABLE Edad ADD CONSTRAINT FK_F469EB48A165460F FOREIGN KEY (reino_id) REFERENCES Reino (id) NOT DEFERRABLE INITIALLY IMMEDIATE");
        ...
        $this->addSql("ALTER TABLE fos_user ADD CONSTRAINT FK_957A64795A91C08D FOREIGN KEY (departamento_id) REFERENCES Departamento (id) NOT DEFERRABLE INITIALLY IMMEDIATE");
        $this->addSql("ALTER TABLE fos_user ADD CONSTRAINT FK_957A6479C604D5C6 FOREIGN KEY (pais_id) REFERENCES Pais (id) NOT DEFERRABLE INITIALLY IMMEDIATE");
        $this->addSql("ALTER TABLE fos_user ADD CONSTRAINT FK_957A64793D8C63B3 FOREIGN KEY (nivelEducativo_id) REFERENCES NivelEducativo (id) NOT DEFERRABLE INITIALLY IMMEDIATE");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE fos_user DROP CONSTRAINT FK_957A64795A91C08D");
        ...
        $this->addSql("ALTER TABLE fos_user DROP CONSTRAINT FK_957A64793D8C63B3");
        $this->addSql("ALTER TABLE fos_user DROP CONSTRAINT FK_957A6479C604D5C6");
        ...
        $this->addSql("ALTER TABLE Edad DROP CONSTRAINT FK_F469EB48A165460F");
        ...
        $this->addSql("DROP SEQUENCE Avistamiento_id_seq CASCADE");
        $this->addSql("DROP SEQUENCE AvistamientoImportado_id_seq CASCADE");
        ...
        $this->addSql("DROP SEQUENCE NivelEducativo_id_seq CASCADE");
        $this->addSql("DROP SEQUENCE Pais_id_seq CASCADE");
        $this->addSql("DROP SEQUENCE Reino_id_seq CASCADE");
        $this->addSql("DROP SEQUENCE Sexo_id_seq CASCADE");
        $this->addSql("DROP SEQUENCE TipoAvistamiento_id_seq CASCADE");
        ...
        $this->addSql("DROP TABLE NivelEducativo");
