 ...
 */
class Version20130615114907 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE Avistamiento (id INT NOT NULL, especie_id INT DEFAULT NULL, tipo_avistamiento_id INT DEFAULT NULL, municipio_id INT DEFAULT NULL, zona_id INT DEFAULT NULL, user_id INT DEFAULT NULL, edad_id INT DEFAULT NULL, fecha TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, cantidad INT NOT NULL, latitud NUMERIC(10, 0) NOT NULL, longitud NUMERIC(10, 0) NOT NULL, comentario TEXT NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("CREATE TABLE Especie (id INT NOT NULL, reino_id INT DEFAULT NULL, nombre_comun VARCHAR(255) NOT NULL, genero VARCHAR(255) NOT NULL, especie VARCHAR(255) NOT NULL, nombre_cientifico VARCHAR(255) NOT NULL, descripcion TEXT NOT NULL, nombre_pech VARCHAR(255) NOT NULL, nombre_tawaka VARCHAR(255) NOT NULL, nombre_garifuna VARCHAR(255) NOT NULL, nombre_misquito VARCHAR(255) NOT NULL, UICN VARCHAR(255) NOT NULL, CITES VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
        $this->addSql("CREATE INDEX IDX_30B52D71A165460F ON Especie (reino_id)");
        $this->addSql("CREATE TABLE Municipio (id INT NOT NULL, nombre VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("CREATE TABLE TipoAvistamiento (id INT NOT NULL, nombre VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
        $this->addSql("CREATE TABLE fos_user (id INT NOT NULL, PRIMARY KEY(id))");
        $this->addSql("CREATE TABLE Zona (id INT NOT NULL, nombre VARCHAR(255) NOT NULL, PRIMARY KEY(id))");
