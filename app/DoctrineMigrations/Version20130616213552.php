 ...
 */
class Version20130616213552 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE AvistamientoImportado (id INT NOT NULL, clase_id INT DEFAULT NULL, tipo_avistamiento_id INT DEFAULT NULL, municipio_id INT DEFAULT NULL, zona_id INT DEFAULT NULL, user_id INT DEFAULT NULL, edad_id INT DEFAULT NULL, sexo_id INT DEFAULT NULL, nombre_comun VARCHAR(255) DEFAULT NULL, nombre_cientifico VARCHAR(255) DEFAULT NULL, genero VARCHAR(255) DEFAULT NULL, localidad VARCHAR(255) DEFAULT NULL, especie VARCHAR(255) DEFAULT NULL, fecha TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, cantidad INT DEFAULT NULL, latitud NUMERIC(12, 9) DEFAULT NULL, longitud NUMERIC(12, 9) DEFAULT NULL, comentario TEXT DEFAULT NULL, PRIMARY KEY(id))");
